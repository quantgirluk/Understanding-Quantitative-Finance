...
This is a collection of notes exploring a number of topics in Quantitative Finance (QF). The idea is to use Python 🐍to illustrate the theoretical concepts using visualizations 📊 which help us to get a better understanding of each topic.
